...
export default function SceneScreen() {
  const {openScene, handleCloseScene, selectedSpot, handleCloseSpotDialog, groupScene, setGroupScene} = useAppStateContext()
  ...
  const handleRemoveSpot = async () => {    
    try {      
      await fetch(`${API_URL}${resource}/${selectedSpot.id}`, {method: "DELETE"});      
